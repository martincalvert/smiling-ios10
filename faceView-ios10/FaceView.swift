...
//  faceView-ios10
//
//  Created by Calvert, Martin on 2/25/17.
...
class FaceView: UIView {
    ...
    private func pathForSkull() -> UIBezierPath{
        let path = UIBezierPath(arcCenter: skullCenter, radius: skullRadius, startAngle: 0, endAngle: 2.0 * CGFloat.pi, clockwise: true)
        path.lineWidth = lineWidth
        return path
    }
